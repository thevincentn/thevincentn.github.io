...
const radref =["0", "Π", "Π/2", "Π/4", "Π/3", "Π/6"];
...
function write_info(ctx, ref, stan){
	...
	ctx.font = "16px Arial";
	ctx. fillStyle = 'blue';
	ctx.fillText("Angle in Standard Position: " + numerator + radref[radidx] + " radians.", 10, canvas.height - 45);
	ctx. fillStyle = 'red';
	ctx.fillText("Reference Angle: " + radref[radidx] + " radians.", 10, canvas.height - 70);
