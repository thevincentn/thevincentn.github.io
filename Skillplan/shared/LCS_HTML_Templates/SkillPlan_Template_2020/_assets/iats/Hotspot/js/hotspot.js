...
HotSpotApp.buildActivity = function () {
	...
	if (HotSpotApp.Scenes[HotSpotApp.sceneNum].Instructions !== 'none' && HotSpotApp.Scenes[HotSpotApp.sceneNum].Instructions !== null && HotSpotApp.Scenes[HotSpotApp.sceneNum].Instructions !== undefined && HotSpotApp.Scenes[HotSpotApp.sceneNum].Instructions !== '') {
		HS_instructions.innerHTML = '<p>' + HotSpotApp.Scenes[HotSpotApp.sceneNum].Instructions + '</p>';
		$(HS_instructions).hide().appendTo(HS_hotSpot).fadeIn();
		//HS_hotSpot.appendChild(HS_instructions);
	} else {
  // <p><span class="HS_instruct_common">Click or tab to each hotspot and select it by clicking or hitting the enter key. Some hotspots may provide additional content or ask follow-up questions.</span></p>
  // <span class="HS_instruct_common">Click or tab to each hotspot and select it by clicking or hitting the enter key. Some hotspots may provide additional content or ask follow-up questions.</span>
		HS_instructions.innerHTML = '<br/>';
		$(HS_instructions).hide().appendTo(HS_hotSpot).fadeIn();
		//HS_hotSpot.appendChild(HS_instructions);
	}
