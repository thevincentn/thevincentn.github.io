...
//						tempTitle.innerHTML = 'Your Answer:';
		...
		GraphicSelectApp.prototype.BuildMiniReport = function (qNum) {
			...
			if (qScore >= maxScore) {
				RespImg.setAttribute('src', '/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/icon-right-24.png');
				RespImg.setAttribute('alt', 'Right Answer Graphic.');
				RespCntx.innerHTML = 'Your answer was correct.';
			} else if (qScore <= 0) {
				RespImg.setAttribute('src', '/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/icon-wrong-24.png');
				RespImg.setAttribute('alt', 'Incorrect Answer Graphic.');
				RespCntx.innerHTML = 'Your answer was incorrect.';
			} else {
				RespImg.setAttribute('src', '/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/icon-partial-24.png');
		...
		GraphicSelectApp.prototype.BuildResultTable = function (qNum) {
			...
			while (i < this._appData.Answers.length) {
				if (this._allCheck[qNum][i] === true)
					if (this._allCorrect[qNum][i] === true) {
						checkedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-checked.png\' class=\'GS_reportIcon\' alt=\'Checked Box Graphic. This checkbox should be selected.\' />';
						// uncheckedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-unchecked.png\' class=\'GS_reportIcon\' alt=\'Correct Answer, Unchecked Box Graphic\' />';
					} else {
						checkedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-fill.png\' class=\'GS_reportIcon\' alt=\'Checked Box Graphic.\' />';
					} else {
					if (this._allCorrect[qNum][i] === true) {
						uncheckedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-unchecked.png\' class=\'GS_reportIcon\' alt=\'Unchecked Box Graphic. This checkbox should be selected.\' />';
					} else {
						uncheckedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-blank.png\' class=\'GS_reportIcon\' alt=\'Unchecked Box Graphic.\' />';
					}
					// checkedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-fill.png\' class=\'GS_reportIcon\' alt=\'Incorrect Answer, Checked Box Graphic\' />';
					// uncheckedBox = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/ans-blank.png\' class=\'GS_reportIcon\' alt=\'Incorrect Answer, Unchecked Box Graphic\' />';
				}
				right = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/icon-right-24.png\' class=\'GS_reportIcon\' alt=\'Right Answer Graphic\' />';
				wrong = '<img src=\'/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/icon-wrong-24.png\' class=\'GS_reportIcon\' alt=\'Wrong Answer Graphic\' />';
				checked = void 0;
				feedback = void 0;
				row = document.createElement('tr');
...
//				mediaDomObj.setAttribute('style', 'text-align:center;');
				...
				mediaDomContent.onerror = function () {
					mediaDomContent.setAttribute('src', '/shared/LCS_HTML_Templates/SkillPlan_Template_2020/_assets/iats/multiselect/img/placeholder-error.png');
