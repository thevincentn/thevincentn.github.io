...
function draw(){
  ...
  if (x == 1){
    ...
    context.beginPath();
    context.fillStyle = "red";
    context.fillRect(centerX - sideLength/2, centerY - sideLength/2-sideLength, sideLength, sideLength);
    context.strokeRect(centerX - sideLength/2, centerY - sideLength/2-sideLength, sideLength, sideLength);

    context.beginPath();
    context.fillStyle = "red";
    context.fillRect(centerX - sideLength/2 + sideLength, centerY - sideLength/2, sideLength, sideLength);
    context.strokeRect(centerX - sideLength/2 + sideLength, centerY - sideLength/2, sideLength, sideLength);

    context.beginPath();
    context.fillStyle = "red";
    context.fillRect(centerX - sideLength/2, centerY + sideLength/2-sideLength+sideLength, sideLength, sideLength);
    context.strokeRect(centerX - sideLength/2, centerY + sideLength/2-sideLength+sideLength, sideLength, sideLength);
