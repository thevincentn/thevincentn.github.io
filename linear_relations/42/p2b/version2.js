...
function draw(){
  ...
  if (x == 1){
    ...
    x++;
    numSquares = numSquares + 3;
  }
  else if (x <= maxIteration){
    context.beginPath();
    context.fillStyle = "blue";
    context.fillRect(leftMost + sideLength + xoffset, centerY-sideLength*2, sideLength, sideLength);
    context.strokeRect(leftMost + sideLength + xoffset, centerY-sideLength*2, sideLength, sideLength);
    ...
    context.beginPath();
    context.fillStyle = "blue";
    context.fillRect(leftMost +sideLength*2 + xoffset, centerY-sideLength, sideLength, sideLength);
    context.strokeRect(leftMost +sideLength*2 + xoffset, centerY-sideLength, sideLength, sideLength);
